...
namespace RTG
{
    ...
    public class RTFocusCamera : MonoSingleton<RTFocusCamera>
    {
        ...
        [SerializeField]
        public CameraLookAroundSettings _lookAroundSettings = new CameraLookAroundSettings();
        [SerializeField]
        private CameraOrbitSettings _orbitSettings = new CameraOrbitSettings();
        [SerializeField]
        public CameraZoomSettings _zoomSettings = new CameraZoomSettings();
        [SerializeField]
...
//             }       
            ...
            if (mouseX != 0.0f || mouseY != 0.0f)
            {
                ...
                else
                {
                    ...
                    if (_lookAroundSettings.IsLookAroundEnabled && Hotkeys.LookAround.IsActive())
                    {
                        ...
                        {
                           // FindObjectOfType<UI_FrontecScene>().State = UI_FrontecScene.SceneStates.Rotating;
        ...
        public bool CanUseMouseScrollWheel()
        {
